...
// CONSIGNA 1
// Ruta Raíz / Home
app.get('/', function(req, res){res.send("Ni Superman, Iron Man o La Mujer Maravilla son tan importantes cómo las y los Héroes de carne y hueso que encontrarás en este sitio. Esperamos que ellas y ellos te sirvan como inspiración para poder cumplir tus objetivos. Recuerda: ¡nunca pares de creer en ti!.")});
// CONSIGNA 2
// Ruta /heroes
// Consigna: enviar todo el array
app.get("/heroes", function(req, res) {res.send(misHeroes);});
// CONSIGNA 3
...
app.get("/creditos", function(req, res) {
  res.send("Carlos Germán Heineken, Good morning sunshine!");});
